            ...
            <KeyboardAvoidingView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 0.5, margin: 25 }}>
                    ...
                    <View style={{ flexDirection: 'row', top: 30 }}>
                        ...
                        <TextInput placeholder="00000000000" style={{ height: 45, borderWidth: 1, borderRadius: 15, left: 15, fontWeight: '500', fontSize: 19, fontSize: 16, width: '70%', paddingLeft: 25 }}   ></TextInput>
                    </View>
                    <CustomTouchableOpacity
                onPress={handlePress1}
                title="Verify"
                colors={['#6A50B2', '#4F99DD']} start={{ x: 0.5, y: 1 }} end={{ x: 1, y: 0.5 }}
                style={{ height: 50, width: 306, borderRadius: 36, justifyContent: 'center', alignItems: 'center', margin: 10, top:'100%' }} // Gradient button style
                />
                </View>
